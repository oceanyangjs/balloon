...
var WelcomeUI = /** @class */ (function () {
    ...
    WelcomeUI.prototype.onButtonLoaded = function () {
        ...
        var btnSprite = new Laya.Sprite;
        btnSprite.graphics.drawRect(100, 100, 20, 20, "#ff0000");
        this.playButton.skin = this.skin;
        this.playButton.width = 0.2 * ConstPara.SCREEN_WIDTH;
        this.playButton.height = 50;
        this.playButton.pos(0.4 * ConstPara.SCREEN_WIDTH, 0.6 * ConstPara.SCREEN_HEIGHT);
